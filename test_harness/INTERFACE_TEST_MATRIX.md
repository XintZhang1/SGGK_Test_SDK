...
3. `loaded_sgt` ABC recut booleans using `generate_corpus_recut_matrix.py`.
4. Sweep families: `sweep_circle_line`, `support_sweep_bspline_surface`.
5. Extrude/thicken families: `extrude_rect`, `thicken_rect_sheet`.
6. Revolve families: `revolve_line`, `revolve_rect`.
7. Prior-result family: `pre_boolean_cylinder_wedge`.
8. Exchange roundtrip: `step_roundtrip`, `iges_roundtrip`.
9. Oracle-specific calibration: point, face-point, clash, distance, plane-extreme.
...
- general offset body/surface beyond `thicken_rect_sheet`
- heal/repair
- fillet/chamfer
