...
- 通过公司批准介质提供的 SGGK SDK、许可及可选源码；
- 可访问的内网 Qwen3.6-35B-A3B OpenAI-compatible Message API。
...
接口解析、Qwen 生成、审查与修改、执行批准、SDK 实测和结果报告。

“Qwen 输出与 Harness 产物”区域列出当前 session 内可预览的 Markdown、JSON、C++、
